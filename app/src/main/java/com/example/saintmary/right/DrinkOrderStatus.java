...
public class DrinkOrderStatus extends AppCompatActivity {
    ...
    private void loadOrders(String phone) {
        ...
        adapter = new FirebaseRecyclerAdapter<DrinkRequest, OrderViewHolder>(
            ...
            @Override
            protected void populateViewHolder(OrderViewHolder viewHolder, DrinkRequest model, final int position) {
                ...
                viewHolder.btn_delete.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        if(adapter.getItem(position).getStatus().equals("0"))
                            ...
                            Toast.makeText(DrinkOrderStatus.this,"you can not delete the order",Toast.LENGTH_SHORT).show();
    ...
    private void deleteOrder(final String key) {
        requests.child(key)
            ...
            public void onSuccess(Void aVoid) {
                Toast.makeText(DrinkOrderStatus.this,new StringBuilder("Order")
                        .append(key)
                ...
                .addOnFailureListener(new OnFailureListener() {
                    ...
                    public void onFailure(@NonNull Exception e) {
                        Toast.makeText(DrinkOrderStatus.this, e.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                });
    }
