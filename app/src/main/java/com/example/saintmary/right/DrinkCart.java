...
//        import com.example.saintmary.right.Database.rightDBHelper;
        ...
        import com.example.saintmary.right.Model.DrinkRequest;
        ...
        import com.example.saintmary.right.ViewHolder.DrinkCartAdapter;
...
public class DrinkCart extends AppCompatActivity {
    ...
    List<DrinkOrder> cart = new ArrayList<>();
    DrinkCartAdapter adapter;
...
*/
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_drink_cart);
...
//        executor.scheduleAtFixedRate(inventorylistthread, 0, 60, TimeUnit.MINUTES);
        ...
        requests = database.getReference("DrinkRequests");

        //Init
        recyclerView = findViewById(R.id.drinkListCart);
        recyclerView.setHasFixedSize(true);
        layoutManager = new LinearLayoutManager(this);
        recyclerView.setLayoutManager(layoutManager);

        txtTotalPrice = findViewById(R.id.drink_total);
        btnPlace = findViewById(R.id.drink_btnPlaceOrder);
    ...
    private void showAlertDialog() {
        AlertDialog.Builder alertDialog=new AlertDialog.Builder(DrinkCart.this);
        alertDialog.setTitle("One more Step");
        alertDialog.setMessage("Enter your address");

        final EditText edtAddress=new EditText(DrinkCart.this);
...
//                new Database(getBaseContext()).cleanCart();//this is found in the Database class
                Toast.makeText(DrinkCart.this,"Thank you,Order place",Toast.LENGTH_SHORT).show();
                finish();
            }
        });
...
//        cart = new Database(this).getCarts();
        // orderList.add(cart);
        adapter = new DrinkCartAdapter(cart, this);
        recyclerView.setAdapter(adapter);

        //Calculate total price
        int total = 200;
        for (DrinkOrder order : cart)
